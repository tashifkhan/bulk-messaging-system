			...
			<div className="flex-1 flex flex-col bg-gray-700">
				...
				<div className="h-16 bg-gray-800 border-b border-gray-600 flex items-center px-6">
					<div className="flex items-center gap-2 text-gray-300">
						...
						<span className="font-medium">
							{activeTab === "gmail" ? "Gmail Configuration" : "SMTP Configuration"}
						</span>
					</div>
				</div>
				...
				<div className="flex-1 overflow-y-auto">
					<div className="max-w-4xl mx-auto p-6">
						...
						{(activeTab === "gmail" ? isGmailAuthenticated : true) && (
							<div className="bg-gray-800 border border-gray-600 rounded-lg p-6 space-y-6">
								...
								<div className="flex justify-end">
									<button
										onClick={activeTab === "gmail" ? sendGmailBulk : sendSMTPBulk}
										disabled={isSending}
						...
						{isSending && (
							<div className="bg-gray-800 border border-gray-600 rounded-lg p-6">
								<h3 className="text-lg font-semibold text-white mb-4">Sending Progress</h3>
								...
								<div className="flex justify-between text-sm text-gray-300 mb-2">
									...
									{progress.recipient && (
										<span className="text-indigo-400">Current: {progress.recipient}</span>
									)}
								</div>
								<p className={`text-sm font-medium ${
									progress.status === 'sent' ? 'text-green-400' : 
									progress.status === 'failed' ? 'text-red-400' : 'text-indigo-400'
								}`}>
